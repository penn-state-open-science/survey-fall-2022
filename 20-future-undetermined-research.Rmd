...
The data will be stored in the PI's password-protected Google Drive account and on the PI's password protected laptop computer.
...
There are no plans to release personally identifying data.
