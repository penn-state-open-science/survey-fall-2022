...
show_unique_units(survey)
```

The results of `show_unique_units(survey)` can then be compared to the [code below ](#modify_dept), and updates made, as needed, to handle various edge cases.
